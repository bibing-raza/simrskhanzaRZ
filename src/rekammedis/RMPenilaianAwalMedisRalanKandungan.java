...
//                    getMasalah();
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getpenilaian_awal_medis_ralan_kebidanan());
        BtnHapus.setEnabled(var.getpenilaian_awal_medis_ralan_kebidanan());
        BtnEdit.setEnabled(var.getpenilaian_awal_medis_ralan_kebidanan());
        BtnEdit.setEnabled(var.getpenilaian_awal_medis_ralan_kebidanan());                    
    }
