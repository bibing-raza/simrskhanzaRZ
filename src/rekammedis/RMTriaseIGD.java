...
public final class RMTriaseIGD extends javax.swing.JDialog {
        ...
        if(tabMode.getRowCount()==0){
            ...
            switch (keputusan) {
                case "Laporan 1":
                    ...
                    Valid.MyReportqry("rptDataTriaseIGD.jrxml", "report", "::[ Data Triase IGD ]::",
    ...
    private void TabSkala3dan4dan5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabSkala3dan4dan5MouseClicked
        if (TabSkala3dan4dan5.getSelectedIndex() == 0) {
            ...
            BtnTambahSkala2.setEnabled(var.getmaster_triase_skala4());
            SekunderZonaHijau.setSelected(true);
        } else if (TabSkala3dan4dan5.getSelectedIndex() == 2) {
            label13.setForeground(new Color(255, 255, 255));
            BtnTambahSkala2.setEnabled(var.getmaster_triase_skala5());
            SekunderZonaHijau.setSelected(true);
        }
                ...
                if(LoadHTML.getText().contains("#AA0000")){
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 1":
                              Valid.MyReport("rptLembarTriaseSkala1.jrxml","report","::[ Triase Skala 1 ]::",param);
                              break;
                        case "PDF Triase Skala 1":
                              Valid.MyReportPDF("rptLembarTriaseSkala1.jrxml","report","::[ Triase Skala 1 ]::",param);
                              break;
                    } 
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 2":
                              Valid.MyReport("rptLembarTriaseSkala2.jrxml","report","::[ Triase Skala 2 ]::",param);
                              break;
                        case "PDF Triase Skala 2":
                              Valid.MyReportPDF("rptLembarTriaseSkala2.jrxml","report","::[ Triase Skala 2 ]::",param);
                              break;
                    } 
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 3":
                              Valid.MyReport("rptLembarTriaseSkala3.jrxml","report","::[ Triase Skala 3 ]::",param);
                              break;
                        case "PDF Triase Skala 3":
                              Valid.MyReportPDF("rptLembarTriaseSkala3.jrxml","report","::[ Triase Skala 3 ]::",param);
                              break;
                    }
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 4":
                              Valid.MyReport("rptLembarTriaseSkala4.jrxml","report","::[ Triase Skala 4 ]::",param);
                              break;
                        case "PDF Triase Skala 4":
                              Valid.MyReportPDF("rptLembarTriaseSkala4.jrxml","report","::[ Triase Skala 4 ]::",param);
                              break;
                    }
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 5":
                              Valid.MyReport("rptLembarTriaseSkala5.jrxml","report","::[ Triase Skala 5 ]::",param);
                              break;
                        case "PDF Triase Skala 5":
                              Valid.MyReportPDF("rptLembarTriaseSkala5.jrxml","report","::[ Triase Skala 5 ]::",param);
                              break;
                    }
                }
                this.setCursor(Cursor.getDefaultCursor());
    ...
    */
    ...
    public void isCek(){
        ...
        if(var.getjml2()>=1){
            ...
            PrimerKodePetugas.setText(var.getkode());
            SekunderKodePetugas.setText(var.getkode());
