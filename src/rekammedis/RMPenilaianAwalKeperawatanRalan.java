...
//        Valid.pindah(evt,RPD,Alergi);
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tbPenilaian.getSelectedRow() > -1) {
            ...
            Valid.MyReport("rptCetakPenilaianAwalKeperawatanRalan.jrxml", "report", "::[ Laporan Penilaian Awal Keperawatan (Assesmen) Ralan ]::",
//            Valid.MyReportqry("rptCetakPenilaianAwalKeperawatanRalan.jasper", "report", "::[ Laporan Penilaian Awal Keperawatan (Assesmen) Ralan ]::",
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getpenilaian_awal_keperawatan_ralan());
        BtnHapus.setEnabled(var.getpenilaian_awal_keperawatan_ralan());
        BtnEdit.setEnabled(var.getpenilaian_awal_keperawatan_ralan());
        BtnEdit.setEnabled(var.getpenilaian_awal_keperawatan_ralan());
        BtnTambahMasalah.setEnabled(var.getmaster_masalah_keperawatan());  
        if(var.getjml2()>=1){
            KdPetugas.setEditable(false);
