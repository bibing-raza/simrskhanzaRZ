...
//            nama_diet.setText(tbAsesmenGZ.getValueAt(tbAsesmenGZ.getSelectedRow(), 26).toString());
    ...
    public void isCek() {
        BtnSimpan.setEnabled(var.getassesmen_gizi_harian());
        BtnGanti.setEnabled(var.getassesmen_gizi_harian());
        BtnHapus.setEnabled(var.getassesmen_gizi_harian());
    }
    ...
    private void isCekKatalog() {
        BtnSimpan1.setEnabled(var.getassesmen_gizi_harian());
        BtnEdit.setEnabled(var.getassesmen_gizi_harian());
    }
