        ...
        for (i = 0; i < tbTambahan.getRowCount(); i++) {
            if (Valid.SetAngka(tbTambahan.getValueAt(i, 1).toString()) > 0) {
                Sequel.menyimpan("tambahan_biaya", "'" + norawat.getText() + "','" + tbTambahan.getValueAt(i, 0).toString()
                        + "','" + tbTambahan.getValueAt(i, 1).toString() + "','" + var.getkode() + "',"
...
//                        subttl = subttl + rsdetaillab.getDouble("total") + lab;
    ...
    public void isCek() {
        ...
        BtnNota.setEnabled(var.gettombolnota_billing());
        ...
        MnReturJual.setEnabled(var.getberi_obat());
        ...
        MnNamaTelahTerima.setEnabled(var.getbilling_ralan());
            ...
            try {
                    ...
                    try {
                        ...
                        if (subttl > 0) {
                            ...
                            Sequel.menyimpan("tambahan_biaya", "'" + TNoRw.getText() + "','Tambahan " + tbBilling.getValueAt(i, 2).toString()
                                    + "','" + tbBilling.getValueAt(i, 6).toString() + "','" + var.getkode() + "',"
                                    + "'" + Sequel.cariIsi("SELECT DATE(NOW())") + "','" + Sequel.cariIsi("SELECT TIME(NOW())") + "'", "Tambahan Biaya");
                        }
                        if (subttl < 0) {
                ...
                if (piutang > 0) {
                    ...
                    Sequel.menyimpan2("tagihan_sadewa", "'" + TNoRw.getText() + "','" + TNoRM.getText() + "','" + TPasien.getText() + "','" + alamat + "',concat('" + Valid.SetTgl(DTPTgl.getSelectedItem() + "")
                            + "',' ',CURTIME()),'Uang Muka','" + total + "','" + bayar + "','Belum','" + var.getkode() + "','" + no_nota + "'", "No.Rawat");
                    ...
                    Sequel.menyimpan2("tagihan_sadewa", "'" + TNoRw.getText() + "','" + TNoRM.getText() + "','" + TPasien.getText() + "','" + alamat + "',concat('" + Valid.SetTgl(DTPTgl.getSelectedItem() + "")
                            + "',' ',CURTIME()),'Pelunasan','" + total + "','" + total + "','Sudah','" + var.getkode() + "','" + no_nota + "'", "No.Rawat");
                }
...
//            JOptionPane.showMessageDialog(null, "Maaf, data tagihan pasien dengan No.Rawat tersebut sudah pernah disimpan...!!!");
    ...
    private void cetakNota() {
        ...
        if (var.getkode().equals("Admin Utama") || BtnSimpan.isEnabled() == false) {
            param.put("petugas_ksr", "( ................... )");
        } else if (var.getbilling_ralan()) {
            param.put("petugas_ksr", "( " + Sequel.cariIsi("select nama from petugas where nip='" + var.getkode() + "'") + " )");
        }

        if (jmlNota > 1) {
            Valid.MyReport("rptNotaRalanBanyak.jrxml", "report", "::[ Nota Pembayaran Banyak - LUNAS (Rawat Jalan) ]::",
                    " SELECT temp1, temp2, temp5, temp7 FROM temporary_bayar_ralan WHERE temp1 <> 'TOTAL BAYAR'", param);
        } else if (jmlNota <= 1) {
            Valid.MyReport("rptNotaRalan.jrxml", "report", "::[ Nota Pembayaran - LUNAS (Rawat Jalan) ]::",
    ...
    private void cetakKwitansiLUNAS() {
        ...
        Valid.MyReport("rptKwitansiRalan.jrxml", "report", "::[ Kwitansi Pembayaran - LUNAS (Rawat Jalan) ]::",
    ...
    private void cetakKwitansiPIUTANG() {
        ...
        Valid.MyReport("rptKwitansiRalanPiutang.jrxml", "report", "::[ Kwitansi Pembayaran - PIUTANG (Rawat Jalan) ]::",
                " SELECT * FROM temporary_bayar_ralan ", param);
    }
}
