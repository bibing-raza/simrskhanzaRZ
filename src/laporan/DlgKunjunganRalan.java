    ...
    public DlgKunjunganRalan(java.awt.Frame parent, boolean modal) {
        ...
        poli.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (var.getform().equals("DlgKunjunganRalan")) {
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void MnKunCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKunCBActionPerformed
        if (tbBangsal.getRowCount() == 0) {
            ...
            Valid.MyReport("rptRekapKunJalanCB.jrxml", "report", "::[ Laporan Rekap Total Kunjungan Pasien Rawat Jalan Berdasarkan Cara Bayar ]::",
    ...
    */
    ...
    public void UserValid() {
        ...
        if (userBerizin.getText().equals("")) {
            ...
            cekSemuaPoli.setSelected(false);
            cekSemuaPoli.setEnabled(false);
            kdpoli.setText(Sequel.cariIsi("SELECT kode_unit FROM hak_akses_unit WHERE nip='" + var.getkode() + "' "));
    ...
    public void ctkKunSemua() {
        ...
        param.put("emailrs", var.getemailrs());
        param.put("periode", Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
        Valid.MyReport("rptKunjunganRalan.jrxml", "report", "::[ Laporan Rekap Kunjungan Pasien Rawat Jalan Semua Poli/Unit ]::",
    ...
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        ...
        param.put("logo", Sequel.cariGambar("select logo from setting"));
        param.put("periode", Tgl1.getSelectedItem() + " s.d " + Tgl2.getSelectedItem());
        Valid.MyReport("rptKunjunganRalanPerPoli.jrxml", "report", "::[ Laporan Rekap Kunjungan Pasien Rawat Jalan Per Poli/Unit ]::",
                " SELECT (SELECT count(x.no_rawat) Total  FROM (SELECT no_rawat FROM reg_periksa "
    ...
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        ...
        Valid.MyReport("rptrekapkunpoliperbulan.jrxml", "report", "::[ Laporan Rekap Kunjungan Poli Per Bulan, Kelompok Pasien, & Jenis Kelamin ]::",
