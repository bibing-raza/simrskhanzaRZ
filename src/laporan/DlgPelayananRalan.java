    ...
    public DlgPelayananRalan(java.awt.Frame parent, boolean modal) {
        ...
        poli.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (var.getform().equals("DlgPelayananRalan")) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (kdPoli.equals("")) {
                ...
                Valid.MyReport("rptPelayananRalan.jrxml", "report", "::[ Laporan Durasi Waktu Pelayanan Rawat Jalan ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    */
    ...
    public void UserValid() {
        userBerizin = "";
        userBerizin = Sequel.cariIsi("SELECT nip FROM hak_akses_unit WHERE nip='" + var.getkode() + "' ");
        ...
        if (userBerizin.equals("")) {
            ...
            cekSemuaPoli.setSelected(false);
            cekSemuaPoli.setEnabled(false);
            kdPoli = Sequel.cariIsi("SELECT kode_unit FROM hak_akses_unit WHERE nip='" + var.getkode() + "' ");
