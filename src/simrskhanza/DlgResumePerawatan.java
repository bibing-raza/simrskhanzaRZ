            ...
            switch (TabRawat.getSelectedIndex()) {
                case 0:
                    bw.write(LoadHTML.getText().replaceAll(
                            ...
                            + "<font size='3' face='Tahoma'><b>" + var.getnamars() + "</b></font><br>"
                            + "<font size='3' face='Tahoma'>" + var.getalamatrs() + ", " + var.getkabupatenrs() + ", " + var.getpropinsirs() + "<br>"
                            + var.getkontakrs() + "e-Mail : " + var.getemailrs() + "<br></font>"
                            + "</td>"
                            + "<td width='40%'>"
                            + "</td>"
                            + "</tr>"
                ...
                case 1:
                    bw.write(LoadHTML2.getText().replaceAll(
                            ...
                            + "<font size='3' face='Tahoma'><b>" + var.getnamars() + "</b></font><br>"
                            + "<font size='3' face='Tahoma'>" + var.getalamatrs() + ", " + var.getkabupatenrs() + ", " + var.getpropinsirs() + "<br>"
                            + var.getkontakrs() + "e-Mail : " + var.getemailrs() + "</font>"
                            + "</td>"
                            + "<td width='40%'>"
                            + "</td>"
                            + "</tr>"
                ...
                case 4:
                    ...
                    break;
                case 5:
                    bw.write(LoadHTML13.getText().replaceAll(
                            "<head>", "<head><link href=\"file.css\" rel=\"stylesheet\" type=\"text/css\" />"
                            + "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"
                            + "<tr class='isi2'>"
                            + "<td width='25%'>"
                ...
                case 11:
                    ...
                    break;
                case 12:
                    bw.write(LoadHTML12.getText().replaceAll(
                            "<head>", "<head><link href=\"file.css\" rel=\"stylesheet\" type=\"text/css\" />"
                            + "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"
                            + "<tr class='isi2'>"
                            + "<td width='25%'>"
