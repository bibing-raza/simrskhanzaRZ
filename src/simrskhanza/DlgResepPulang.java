    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if (stokbarang2 < Double.parseDouble(Jml.getText()) || TStok.getText().equals("")) {
                ...
                Trackobat.catatRiwayat2(KdBarang.getText(),0,Valid.SetAngka(Jml.getText()),"Resep Pulang",var.getkode(),bangsal,"Simpan");
                Trackobat.catatRiwayatObat2(KdBarang.getText(), 0, Valid.SetAngka(Jml.getText()), "Resep Pulang", var.getkode(), bangsal, "Simpan", TNoRM.getText(), TNoRw.getText());
