            ...
            if (stokbarang2 < y || TStok.getText().equals("")) {
                ...
                if (Valid.SetAngka(tbKamar.getValueAt(i, 0).toString()) > 0) {
                    if (Sequel.menyimpantf("resep_pulang", "?,?,?,?,?,?", "data", 6, new String[]{
                        ...
                        isRawat();
                        Trackobat.catatRiwayat2(tbKamar.getValueAt(i, 1).toString(), 0, Valid.SetAngka(tbKamar.getValueAt(i, 0).toString()), "Resep Pulang", var.getkode(), bangsal, "Simpan");
                        Trackobat.catatRiwayatObat2(tbKamar.getValueAt(i,1).toString(),0,Double.parseDouble(tbKamar.getValueAt(i,0).toString()),"Resep Pulang",var.getkode(),bangsal,"Simpan",TNoRm.getText(),TNoRw.getText());
