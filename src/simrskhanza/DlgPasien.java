        ...
        if (p2 < 0) {
            ...
            if (((!TNoPeserta.getText().equals("0")) && (!TNoPeserta.getText().equals("-"))) || ((!TKtp.getText().equals("0")) && (!TKtp.getText().equals("-")))) {
                if (cekPeserta > 0 || cekKTP > 0) {
                    ...
                    Sequel.menyimpan("history_user", "Now(),'-','" + var.getkode() + "','" + keterangan + "','Simpan'");
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    ...
    Sequel.menyimpan("history_user", "Now(),'-','" + var.getkode() + "','Input Pasien Baru','Hapus'");
    tampil();
    emptTeks();
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    public void emptTeks() {
        ...
        } else if ((var.getkode().equals("PP24")) || (var.getkode().equals("PP23"))) {
            Kdpnj.setText("U01");
            nmpnj.setText("UMUM");
