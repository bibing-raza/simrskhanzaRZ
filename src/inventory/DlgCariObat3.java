                ...
                for(i=0;i<jml;i++){   
                    ...
                    if(retur>0){
                        ...
                        try {
                            ...
                            if(rsretur.next()){
                                Trackobat.catatRiwayat2(tbObat.getValueAt(i,1).toString(),0,rsretur.getDouble("jml"),"Retur Pasien",var.getkode(),bangsal,"Hapus");
                        ...
                        try {
                            ...
                            Trackobat.catatRiwayat2(tbObat.getValueAt(i,1).toString(),retur,0,"Retur Pasien",var.getkode(),bangsal,"Simpan");
