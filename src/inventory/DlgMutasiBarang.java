                        ...
                        try {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                                if (Sequel.menyimpantf("mutasibarang", "'" + tbDokter.getValueAt(i, 1).toString() + "','" + Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) + "','" + kddari.getText() + "',"
                                    ...
                                    Trackobat.catatRiwayat2(tbDokter.getValueAt(i, 1).toString(), 0, Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), "Mutasi", var.getkode(), kddari.getText(), "Simpan");
                                    ...
                                    Trackobat.catatRiwayat2(tbDokter.getValueAt(i, 1).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), 0, "Mutasi", var.getkode(), kdke.getText(), "Simpan");
