                ...
                if (var.getkode().equals("Admin Utama")) {
                    ...
                    if (Sequel.menyimpantf("detail_pemberian_obat", "'" + Valid.SetTgl(DTPBeri.getSelectedItem() + "") + "','"
                        ...
                        if (btnObat1.isEnabled() == true) {
                            ...
                            Trackobat.catatRiwayatObat(TKdOb.getText(), 0, Valid.SetAngka(TJumlah.getText()), "Pemberian Obat", var.getkode(), bangsal, "Simpan", TNoRM.getText(), TNoRw.getText(), Valid.SetTgl(DTPBeri.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem());
                    ...
                    if (var.getkode().equals("Admin Utama")) {
                        ...
                        if (Sequel.queryutf("delete from detail_pemberian_obat where no_rawat='" + tbPemberianObat.getValueAt(i, 2).toString() + "' "
                            ...
                            if (statusberi.equals("Ranap")) {
                                ...
                                jur.simpanJurnal(tbPemberianObat.getValueAt(i, 2).toString(), tbPemberianObat.getValueAt(i, 0).toString(), "U", "PEMBATALAN PEMBERIAN OBAT RAWAT INAP PASIEN, OLEH " + var.getkode());
                            }
                            ...
                            if (btnObat1.isEnabled() == true) {
                                Trackobat.catatRiwayat(tbPemberianObat.getValueAt(i, 5).toString(),
                                        ...
                                        0, "Pemberian Obat", var.getkode(), bangsal, "Hapus", Valid.SetTgl(DTPBeri.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem());
                                Trackobat.catatRiwayatObat(tbPemberianObat.getValueAt(i, 5).toString(), Valid.SetAngka(tbPemberianObat.getValueAt(i, 9).toString()), 0, "Pemberian Obat", var.getkode(), bangsal, "Hapus", TNoRM.getText(), TNoRw.getText(), Valid.SetTgl(DTPBeri.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem());
...
//            }
    ...
    public void isCek() {
        ...
        ppLaporanFarmasi.setEnabled(var.getlaporanfarmasi());
        ChkJln.setSelected(true);
    }
...
//        this.namadokter=namadokter;
    ...
    private void isStok(String a) {
        Sequel.cariIsi("select ifnull(stok,'0') from gudangbarang where kd_bangsal=? and kode_brng=?", TStok, var.getkdbangsal(), a);
    }
