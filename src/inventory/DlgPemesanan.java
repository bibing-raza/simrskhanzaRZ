                            ...
                            try {
                                if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                                    if (Sequel.menyimpantf2("detailpesan", "?,?,?,?,?,?,?,?,?,?,?", "Transaksi Pemesanan", 11, new String[]{
                                        ...
                                        Trackobat.catatRiwayat2(tbDokter.getValueAt(i, 2).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), 0, "Pemesanan", var.getkode(), kdgudang.getText(), "Simpan");
