     ...
     try {
         ...
         while(rscaripiutang.next()){
             ...
             while(rsdetailpiutang.next()){
                 Trackobat.catatRiwayat2(rsdetailpiutang.getString("kode_brng"),rsdetailpiutang.getDouble("jumlah"),0,"Piutang",var.getkode(),rscaripiutang.getString("kd_bangsal"),"Hapus");
