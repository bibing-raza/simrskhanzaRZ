...
public class ADAM_Api {
    ...
    public void kirim(String noRawatAdam, String Tglperiksa, String jamPeriksa, 
             ...
             try {
                ...
                while(rs.next()){
                    ...
                    ps2 = koneksi.prepareStatement(
                            ...
                            + "and pl.tgl_periksa = d.tgl_periksa and d.jam = pl.jam WHERE pl.no_rawat='" + noRawatAdam + "' and "
...
//                    System.out.println("Output : " + stringbalik);
                    ...
                    if (root.path("success").asText().equals("false")) {
                        Sequel.menyimpan("lis_error_log", "'0','" + noRawatAdam + "','SIMRS ke LIS',"
                                + "'" + root.path("message").asText() + "','" + stringbalik + "',Now() ", "Error LIS");
                        JOptionPane.showMessageDialog(null,"Data gagal terkirim ke alat Laboratorium "+"("+root.path("description").path("cause").path("raw").asText()+")");
                    } else {
                        Sequel.menyimpan("lis_reg", "'" + root.path("payload").path("no_lab").asText() + "','" + noRawatAdam + "','" + Tglperiksa + "',"
                                + "'" + jamPeriksa + "','" + kdDokter + "','" + kdUnit + "','" + diagnosa + "','" + ketKlinis + "',Now(), '" + requestJson + "'", "Berhasil LIS");
