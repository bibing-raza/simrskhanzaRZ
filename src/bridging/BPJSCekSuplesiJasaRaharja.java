...
public final class BPJSCekSuplesiJasaRaharja extends javax.swing.JDialog {
    ...
    public BPJSCekSuplesiJasaRaharja(java.awt.Frame parent, boolean modal) {
        ...
        pasien.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(var.getform().equals("DlgBPJSCekSuplesiJasaRaharja")){
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptCariBPJSSuplesiJasaRaharja.jrxml", "report", "[ Data Suplesi Jasa Raharja ]", param);
            this.setCursor(Cursor.getDefaultCursor());
        }        
    }//GEN-LAST:event_BtnPrintActionPerformed

    private void btnPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPasienActionPerformed
        var.setform("DlgBPJSCekSuplesiJasaRaharja");
        pasien.emptTeks();
        pasien.isCek();
