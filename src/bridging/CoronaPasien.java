...
public class CoronaPasien extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPasienCorona.jrxml", "report", "::[ Data Bridging Pasien Corona Kemenkes RI ]::",
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getpasien_corona());
        BtnHapus.setEnabled(var.getpasien_corona());
        BtnEdit.setEnabled(var.getpasien_corona());
        ppDiagnosaPasien.setEnabled(var.getdiagnosa_pasien_corona());
    }
