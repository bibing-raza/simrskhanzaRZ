...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
        ...
        if (tabMode2.getRowCount() == 0) {
            ...
            Valid.MyReport("rptDiagnosaCorona.jrxml", "report", "::[ Data Bridging Kemenkes RI Diagnosa Pasien Teridentifikasi Corona ]::",
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getdiagnosa_pasien_corona());
        BtnHapus.setEnabled(var.getdiagnosa_pasien_corona());
    }
