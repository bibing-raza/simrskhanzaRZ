    ...
    public DlgDataKanker(java.awt.Frame parent, boolean modal) {
        ...
        jk.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (var.getform().equals("DlgDataKanker")) {
...
//        Valid.pindah(evt,PindahRO,FotoTorak);
    ...
    */
    ...
    public void isCek(){
        ...
        tampil();
        BtnSimpan.setEnabled(var.getkemenkes_kanker());
        BtnHapus.setEnabled(var.getkemenkes_kanker());
        BtnEdit.setEnabled(var.getkemenkes_kanker());
    }
