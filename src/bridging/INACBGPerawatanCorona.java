...
public class INACBGPerawatanCorona extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPerawatanCorona.jrxml", "report", "::[ Kebutuhan Perawatan Pasien Corona Untuk Penagihan INACBG ]::",
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getperawatan_pasien_corona());
        BtnHapus.setEnabled(var.getperawatan_pasien_corona());
        BtnEdit.setEnabled(var.getperawatan_pasien_corona());
    }
