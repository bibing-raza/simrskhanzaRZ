    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (R1.isSelected() == true) {
                ...
                Valid.MyReport("rptBridgingSuratPRI.jrxml", "report", "::[ Data Surat PRI VClaim ]::",
  ...
  isForm();                
    ...
    private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
        if (tbSPRI.getSelectedRow() != -1) {
            ...
            Valid.MyReport("rptBridgingSuratPRI2.jrxml", "report", "::[ Cetak SPRI VClaim ]::",
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getSPRIJKN());
        BtnHapus.setEnabled(var.getSPRIJKN());
        BtnPrint.setEnabled(var.getSPRIJKN());
        BtnEdit.setEnabled(var.getSPRIJKN());
    }
