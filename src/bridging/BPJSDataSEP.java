...
public final class BPJSDataSEP extends javax.swing.JDialog {
    private DefaultTableModel tabMode, tabMode1, tabMode2, tabMode3, tabMode4, tabMode5, tabMode6;
...
//    private DlgSKDPBPJS skdp = new DlgSKDPBPJS(null, false);
    ...
    private String no_peserta = "", requestJson, URL = "", jkel = "", duplikat = "", user = "", tglkkl = "", tglkkl_ok = "", jnsrawat = "", dialog_simpan = "",
            ...
            kdprosedur = "", nmprosedur = "", diagSekunderKirim = "", prosedurKirim = "", diagSekunderSimpan = "", prosedurSimpan = "",
...
//        });
    ...
    private void initComponents() {
        ...
        ppProgramPRB.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppRencanaKontrollagi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppDataRujukanKeluar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppRujukanBiasa.setPreferredSize(new java.awt.Dimension(150, 25));
        ...
        ppRujukanKhusus.setPreferredSize(new java.awt.Dimension(150, 25));
        ...
        tglMati.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2022" }));
        ...
        noLP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2022" }));
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Membuat Rujukan Keluar VClaim (BIASA) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        TanggalRujukKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2022" }));
        ...
        tglRencanaKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2022" }));
        ...
        internalFrame10.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Membuat Rujukan Keluar VClaim (KHUSUS) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Bridging SEP VClaim BPJS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2022" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2022" }));
        ...
        TanggalKejadian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2022" }));
        ...
        if (TNoRw.getText().trim().equals("")) {
            ...
            if (tabMode.getRowCount() < 0) {
                ...
                suratKontrol.setNoRm(TNoRw.getText(), SEPkontrol, NoKartu.getText(), TNoRM.getText(), 
                        TPasien.getText(), TglLahir.getText(), tbSEP.getValueAt(tbSEP.getSelectedRow(), 28).toString(), NmPenyakit.getText());
...
//                JsonNode response = root.path("response");
                ...
                if (nameNode.path("code").asText().equals("200")) {
                    ...
                    Sequel.menyimpan("history_user", "Now(),'" + TNoRw.getText() + "','" + var.getkode() + "','Rujukan Biasa Keluar VClaim','Ganti'");
                } else {
                    JOptionPane.showMessageDialog(null, nameNode.path("message").asText());
                }
            } catch (Exception ex) {
...
//                    this.setCursor(Cursor.getDefaultCursor());
                    ...
                    Sequel.menyimpan("history_user", "Now(),'" + TNoRw.getText() + "','" + var.getkode() + "','Rujukan Khusus Keluar VClaim','Simpan'");
                } else {
                    JOptionPane.showMessageDialog(null, nameNode.path("message").asText());
                }
            } catch (Exception ex) {
...
//        BtnHapus.setEnabled(var.getbpjs_sep());
        ...
        ppSEPinternal.setEnabled(var.getbpjs_sep());
        ppPengajuan.setEnabled(var.getbpjs_sep());
        ppAprovalSEP.setEnabled(var.getbpjs_sep());
        ppProgramPRB.setEnabled(var.getbpjs_sep());
        ppAmbilSep.setEnabled(var.getbpjs_sep());
        ppSPRI.setEnabled(var.getSPRIJKN());
        ppRencanaKontrol.setEnabled(var.getRencanaKontrolJKN());
        ppPulang.setEnabled(var.getbpjs_sep());
        ppSEP.setEnabled(var.getbpjs_sep());
        ppUpdateSEPdariVclaim.setEnabled(var.getbpjs_sep());
        ppRujukanBiasa.setEnabled(var.getbpjs_sep());
        ppMembuatRujukan.setEnabled(var.getbpjs_sep());        
        ppDataRujukanKeluar.setEnabled(var.getbpjs_sep());
