...
public final class BPJSCekRujukanKartuPCare extends javax.swing.JDialog {
    ...
    private BPJSCekReferensiPropinsi provi=new BPJSCekReferensiPropinsi(null,false);
    private BPJSCekReferensiKabupaten kabu=new BPJSCekReferensiKabupaten(null,false);
    private BPJSCekReferensiKecamatan keca=new BPJSCekReferensiKecamatan(null,false);
    ...
    public BPJSCekRujukanKartuPCare(java.awt.Frame parent, boolean modal) {
        ...
        provi.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(provi.getTable().getSelectedRow()!= -1){                   
                    KdProv.setText(provi.getTable().getValueAt(provi.getTable().getSelectedRow(),1).toString());
                    NmProv.setText(provi.getTable().getValueAt(provi.getTable().getSelectedRow(),2).toString());
        ...
        provi.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
        ...
        kabu.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(kabu.getTable().getSelectedRow()!= -1){                   
                    KdKab.setText(kabu.getTable().getValueAt(kabu.getTable().getSelectedRow(),1).toString());
                    NmKab.setText(kabu.getTable().getValueAt(kabu.getTable().getSelectedRow(),2).toString());
                    btnKab.requestFocus();
                }                  
            }
            @Override
        ...
        kabu.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
        ...
        keca.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(keca.getTable().getSelectedRow()!= -1){                   
                    KdKec.setText(keca.getTable().getValueAt(keca.getTable().getSelectedRow(),1).toString());
                    NmKec.setText(keca.getTable().getValueAt(keca.getTable().getSelectedRow(),2).toString());
                    btnKec.requestFocus();
                }                  
            }
            @Override
        ...
        keca.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2018" }));
        ...
        MnDocument.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppPengajuan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ppPengajuan1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Rujukan PCare Berdasarkan Nomor Kartu ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        FormKelengkapanPasien.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(237, 242, 232)), "::[ Kelengkapan Data Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        DTPDaftar.setForeground(new java.awt.Color(0, 0, 0));
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2018" }));
        ...
        jLabel23.setBounds(430, 55, 80, 23);

        TanggalSEP.setEditable(false);
        TanggalSEP.setForeground(new java.awt.Color(0, 0, 0));
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2018 01:05:24" }));
        TanggalSEP.setDisplayFormat("dd-MM-yyyy");
        TanggalSEP.setDoubleBuffered(true);
        ...
        TanggalSEP.setBounds(515, 55, 90, 23);
        ...
        jLabel30.setBounds(430, 25, 80, 23);

        TanggalRujuk.setEditable(false);
        TanggalRujuk.setForeground(new java.awt.Color(0, 0, 0));
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2018 01:05:24" }));
        TanggalRujuk.setDisplayFormat("dd-MM-yyyy");
        TanggalRujuk.setDoubleBuffered(true);
        ...
        TanggalRujuk.setBounds(515, 25, 90, 23);
        ...
        jLabel31.setBounds(624, 25, 70, 23);

        NoRujukan2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NoRujukan2.setBounds(700, 25, 165, 23);
        ...
        Catatan.setBounds(303, 85, 150, 23);
        ...
        JenisPelayanan.setBounds(515, 115, 105, 23);
        ...
        LabelKelas.setBounds(624, 115, 70, 23);
        ...
        LakaLantas.setBounds(700, 55, 90, 23);
        ...
        jLabel36.setBounds(430, 175, 80, 23);
        ...
        BtnDokter.setBounds(855, 175, 28, 23);
        ...
        jLabel38.setBounds(430, 145, 80, 23);
        ...
        Eksekutif.setBounds(515, 145, 105, 23);
        ...
        LabelKelas1.setBounds(624, 145, 70, 23);
        ...
        ChkJasaRaharja.setBounds(955, 25, 110, 23);
        ...
        ChkBPJSTenaga.setBounds(955, 55, 130, 23);
        ...
        ChkTaspen.setBounds(1090, 25, 80, 23);
        ...
        ChkAsa.setBounds(1090, 55, 80, 23);

        jLabel40.setForeground(new java.awt.Color(0, 0, 0));
        jLabel40.setText("Tgl.KLL :");
        jLabel40.setName("jLabel40"); // NOI18N
        jLabel40.setPreferredSize(new java.awt.Dimension(55, 23));
        FormKelengkapanSEP.add(jLabel40);
        jLabel40.setBounds(455, 85, 55, 23);

        TanggalKejadian.setEditable(false);
        TanggalKejadian.setForeground(new java.awt.Color(0, 0, 0));
        TanggalKejadian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-09-2018" }));
        ...
        FormKelengkapanSEP.add(TanggalKejadian);
        TanggalKejadian.setBounds(515, 85, 90, 23);

        jLabel35.setForeground(new java.awt.Color(0, 0, 0));
        jLabel35.setText("Keterangan :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormKelengkapanSEP.add(jLabel35);
        jLabel35.setBounds(624, 85, 70, 23);
        ...
        FormKelengkapanSEP.add(KdProv);
        KdProv.setBounds(955, 85, 60, 23);
        ...
        FormKelengkapanSEP.add(KdKab);
        KdKab.setBounds(955, 115, 60, 23);
        ...
        FormKelengkapanSEP.add(KdKec);
        KdKec.setBounds(955, 145, 60, 23);
        ...
        suplesi.setBounds(955, 175, 70, 23);
        ...
        NoSEPSuplesi.setBounds(975, 205, 250, 23);
        ...
        FormKelengkapanSEP.add(NmProv);
        NmProv.setBounds(1020, 85, 170, 23);
        ...
        FormKelengkapanSEP.add(NmKab);
        NmKab.setBounds(1020, 115, 170, 23);
        ...
        FormKelengkapanSEP.add(NmKec);
        NmKec.setBounds(1020, 145, 170, 23);
        ...
        FormKelengkapanSEP.add(btnProv);
        btnProv.setBounds(1195, 85, 28, 23);
        ...
        FormKelengkapanSEP.add(btnKab);
        btnKab.setBounds(1195, 115, 28, 23);
        ...
        FormKelengkapanSEP.add(btnKec);
        btnKec.setBounds(1195, 145, 28, 23);
        ...
        FormKelengkapanSEP.add(LabelKatarak);
        LabelKatarak.setBounds(3, 205, 100, 23);
        ...
        FormKelengkapanSEP.add(KasusKatarak);
        KasusKatarak.setBounds(110, 205, 70, 23);

        jLabel41.setForeground(new java.awt.Color(0, 0, 0));
        jLabel41.setText("No. Surat SKDP :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormKelengkapanSEP.add(jLabel41);
        jLabel41.setBounds(187, 205, 85, 23);
        ...
        noSKDP.setBounds(277, 205, 105, 23);
        ...
        FormKelengkapanSEP.add(btnNoSKDP);
        btnNoSKDP.setBounds(387, 205, 28, 23);

        jLabel42.setForeground(new java.awt.Color(0, 0, 0));
        jLabel42.setText("DPJP SEP :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormKelengkapanSEP.add(jLabel42);
        jLabel42.setBounds(430, 205, 80, 23);
        ...
        Kddpjp.setBounds(515, 205, 70, 23);
        ...
        NmDPJP.setBounds(590, 205, 260, 23);
        ...
        btnDPJP.setBounds(855, 205, 28, 23);
    ...
    private void btnProvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProvActionPerformed
        pilihan = 1;
        provi.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
        provi.setLocationRelativeTo(internalFrame1);
    ...
    private void btnKabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKabActionPerformed
        pilihan = 1;
        kabu.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
        kabu.setLocationRelativeTo(internalFrame1);
        kabu.setVisible(true);
        kabu.fokus(KdProv.getText(), NmProv.getText());
    ...
    private void btnKecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKecActionPerformed
        pilihan = 1;
        keca.setSize(internalFrame1.getWidth() - 40, internalFrame1.getHeight() - 40);
        keca.setLocationRelativeTo(internalFrame1);
        keca.setVisible(true);
        keca.fokus(KdKab.getText(), NmKab.getText());
